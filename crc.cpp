...
// 构造crc16表
// 参数为0x8005：CRC_16，多项式：x^16 + x^15 + x^2 + 1
// 参数为0x1021：CRC_CCITT，多项式：x^16 + x^12 + x^5 + 1
...
{
    char *p = "hello,world.";
    char tmp[] = {0x49, 0x48, 0x44, 0x52, 0x00, 0x00, 0x00, 0xf0, 
                  0x00, 0x00, 0x01, 0x40, 0x08, 0x02, 0x00, 0x00, 0x00};
    int crc = 0;
    ...
    crc = crc32((unsigned char *)tmp, (u32)sizeof(tmp));
    printf("tmp: crc: %X\n", crc);
    // crc16 test
